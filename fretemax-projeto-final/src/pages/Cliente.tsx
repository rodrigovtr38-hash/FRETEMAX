...
import { ArrowLeft, ShieldCheck, Zap, Truck, Package, MapPin, Navigation, XCircle, RefreshCw, Loader2, CheckCircle } from 'lucide-react';
...
export default function Cliente() {
  ...
  useEffect(() => {
    ...
    if (savedOrderId) { setCurrentOrderId(savedOrderId); setStep('busca'); }
  }, []);
