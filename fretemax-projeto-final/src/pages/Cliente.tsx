...
const inputClass = "w-full rounded-2xl border-2 border-slate-200 bg-white p-5 text-base md font-bold text-slate-900 transition-all placeholder focus focus focus/10 outline-none";
const smallInputClass = "w-full rounded-2xl border-2 border-slate-200 bg-white p-4 text-sm font-bold text-slate-900 transition-all placeholder focus focus focus/10 outline-none";
